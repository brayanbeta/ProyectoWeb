...
namespace ProyectoWeb.Controllers
{
    ...
    public class DetalleCotizacionController : ControllerBase
    {
        ...
        {
            var item = await _context.DetalleCotizaciones.FindAsync(detalleCotizacion.SecuenciaNumeroDetalle);
            if (item != null)
            {
                return BadRequest();
            }
            else
            {
                ...
                return CreatedAtAction(nameof(GetDetalleCotizacionItem), new { id = detalleCotizacion.SecuenciaNumeroDetalle }, detalleCotizacion);
            }
        }
        ...
        {
            if (id != item.SecuenciaNumeroDetalle)
            {
                return BadRequest();
            }
