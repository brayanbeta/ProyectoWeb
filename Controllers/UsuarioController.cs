...
namespace ProyectoWeb.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        {   
            ...
            {
                _context.Usuarios.Add(new Usuario { Identificacion = "1003243556", Email= "NIYER@SHOP.COM", Nombre = "NIYER",Apellido="OÑATE",Telefono="3154987434",Sexo="MASCULINO",Direccion="CALLE 51 # 28-73",Rol="ADMINISTRADOR",Password="12345"});
